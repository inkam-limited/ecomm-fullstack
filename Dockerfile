...
ARG _BASE_URL
ARG _NEXT_PUBLIC_AAMARPAY_STORE_ID
ARG _NEXT_PUBLIC_AAMARPAY_SIGNATURE_KEY
ARG _SIGNATURE_KEY
ARG _STORE_ID
...
ENV NEXT_PUBLIC_AAMARPAY_STORE_ID=$_NEXT_PUBLIC_AAMARPAY_STORE_ID
ENV NEXT_PUBLIC_AAMARPAY_SIGNATURE_KEY=$_NEXT_PUBLIC_AAMARPAY_SIGNATURE_KEY
